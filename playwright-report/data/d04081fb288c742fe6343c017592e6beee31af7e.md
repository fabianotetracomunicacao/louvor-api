...
- Name: player.spec.js >> Módulo 2: Player, Cifras e Interação Extrema >> Deve suportar troca ultra-rápida de tonalidades (Transposição Stress Test)
- Location: tests/e2e/player.spec.js:43:3
...
Call log:
  - waiting for locator('input[placeholder*="Buscar"]')
